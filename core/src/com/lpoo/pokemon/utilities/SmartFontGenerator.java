package com.lpoo.pokemon.utilities;
...
import com.lpoo.pokemon.utilities.BitmapFontWriter;
...
public class SmartFontGenerator {
	...
	private BitmapFont generateFontWriteFiles(String fontName, FileHandle fontFile, int fontSize, int pageWidth, int pageHeight) {
		...
		BitmapFont font = new com.badlogic.gdx.graphics.g2d.BitmapFont(fontData, texRegions, false);
